...
import net.alternativewill.kingdomsanddynasties2.item.client.Jingasa4Renderer;
...
public class Jingasa4Item extends DyeableArmorItem implements GeoItem {
    ...
    public Jingasa4Item(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private Jingasa4Renderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new Jingasa4Renderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return RendererInstances.JINGASA4_ITEM_RENDERER;
            }
        });
    }
    ...
    public int getColor(@NotNull ItemStack stack) {
        return getColorTag(stack, Jingasa4Item.CRAFTING_TABLE_PART, STANDARD_CRAFTING_TABLE_COLOR);
    }
