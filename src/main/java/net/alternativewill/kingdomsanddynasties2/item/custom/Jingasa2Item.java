...
import net.alternativewill.kingdomsanddynasties2.item.client.Jingasa2Renderer;
...
public class Jingasa2Item extends DyeableArmorItem implements GeoItem {
    ...
    public Jingasa2Item(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private Jingasa2Renderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new Jingasa2Renderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return RendererInstances.JINGASA2_ITEM_RENDERER;
            }
        });
    }
    ...
    public int getColor(@NotNull ItemStack stack) {
        return getColorTag(stack, Jingasa2Item.CRAFTING_TABLE_PART, STANDARD_CRAFTING_TABLE_COLOR);
    }
