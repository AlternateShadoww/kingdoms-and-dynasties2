...
import net.alternativewill.kingdomsanddynasties2.item.client.EboshiHat2Renderer;
...
public class EboshiHat2Item extends DyeableArmorItem implements GeoItem {
    ...
    public EboshiHat2Item(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private EboshiHat2Renderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new EboshiHat2Renderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return RendererInstances.EBOSHIHAT2_ITEM_RENDERER;
            }
        });
    }
    ...
    public int getColor(@NotNull ItemStack stack) {
        return getColorTag(stack, EboshiHat2Item.CRAFTING_TABLE_PART, STANDARD_CRAFTING_TABLE_COLOR);
    }
