...
import net.alternativewill.kingdomsanddynasties2.item.client.GiNewRenderer;
...
public class GiNewItem extends DyeableArmorItem implements GeoItem {
    ...
    public GiNewItem(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private GiNewRenderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new GiNewRenderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return RendererInstances.GINEW_ITEM_RENDERER;
            }
        });
    }
    ...
    public void setPrimaryColor(@NotNull ItemStack stack, int color) {
        setColorTag(stack, GiNewItem.PRIMARY_PART, color, STANDARD_PRIMARY_COLOR);
    }

    public void setSecondaryColor(@NotNull ItemStack stack, int color) {
        setColorTag(stack, GiNewItem.SECONDARY_PART, color, STANDARD_SECONDARY_COLOR);
    }


    public int getPrimaryColor(@NotNull ItemStack stack) {
        return getColorTag(stack, GiNewItem.PRIMARY_PART, STANDARD_PRIMARY_COLOR);
    }

    public int getSecondaryColor(@NotNull ItemStack stack) {
        return getColorTag(stack, GiNewItem.SECONDARY_PART, STANDARD_SECONDARY_COLOR);
    }
    ...
    public void undoColor(ItemStack stack, int buttonIndex) {
        if (stack.getItem() instanceof GiNewItem yoroiArmorItem) {
            switch (buttonIndex) {
