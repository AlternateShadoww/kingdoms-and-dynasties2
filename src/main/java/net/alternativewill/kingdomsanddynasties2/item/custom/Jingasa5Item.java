...
import net.alternativewill.kingdomsanddynasties2.item.client.Jingasa5Renderer;
...
public class Jingasa5Item extends DyeableArmorItem implements GeoItem {
    ...
    public Jingasa5Item(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private Jingasa5Renderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new Jingasa5Renderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return RendererInstances.JINGASA5_ITEM_RENDERER;
            }
        });
    }
    ...
    public int getColor(@NotNull ItemStack stack) {
        return getColorTag(stack, Jingasa5Item.CRAFTING_TABLE_PART, STANDARD_CRAFTING_TABLE_COLOR);
    }
