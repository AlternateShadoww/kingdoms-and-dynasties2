...
import net.alternativewill.kingdomsanddynasties2.item.client.Jingasa1Renderer;
...
public class Jingasa1Item extends DyeableArmorItem implements GeoItem {
    ...
    public Jingasa1Item(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private Jingasa1Renderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new Jingasa1Renderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return RendererInstances.JINGASA1_ITEM_RENDERER;
            }
        });
    }
    ...
    public int getColor(@NotNull ItemStack stack) {
        return getColorTag(stack, Jingasa1Item.CRAFTING_TABLE_PART, STANDARD_CRAFTING_TABLE_COLOR);
    }
