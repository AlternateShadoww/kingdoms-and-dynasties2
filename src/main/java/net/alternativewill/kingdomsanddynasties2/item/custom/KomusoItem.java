...
import net.alternativewill.kingdomsanddynasties2.item.client.KomusoRenderer;
...
public class KomusoItem extends DyeableArmorItem implements GeoItem {
    ...
    public KomusoItem(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private KomusoRenderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new KomusoRenderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return RendererInstances.KOMUSO_ITEM_RENDERER;
            }
        });
    }
    ...
    public int getColor(@NotNull ItemStack stack) {
        return getColorTag(stack, KomusoItem.CRAFTING_TABLE_PART, STANDARD_CRAFTING_TABLE_COLOR);
    }
