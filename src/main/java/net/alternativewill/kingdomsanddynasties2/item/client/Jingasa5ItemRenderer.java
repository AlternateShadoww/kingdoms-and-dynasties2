...
public class Jingasa5ItemRenderer extends DyeableGeoItemRenderer<Jingasa5Item> {

    protected float partialTick;

    public Jingasa5ItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (Jingasa5Item)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(Jingasa5Item animatable, ResourceLocation texture,
