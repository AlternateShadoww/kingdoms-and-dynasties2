...
public class SujiKabutoItemRenderer extends DyeableGeoItemRenderer<SujiKabutoItem> {

    protected float partialTick;

    public SujiKabutoItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (SujiKabutoItem)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(SujiKabutoItem animatable, ResourceLocation texture,
