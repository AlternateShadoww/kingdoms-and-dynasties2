...
public class EboshiHatItemRenderer extends DyeableGeoItemRenderer<EboshiHatItem> {

    protected float partialTick;

    public EboshiHatItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (EboshiHatItem)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(EboshiHatItem animatable, ResourceLocation texture,
