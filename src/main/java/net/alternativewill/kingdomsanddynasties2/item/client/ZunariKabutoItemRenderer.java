...
public class ZunariKabutoItemRenderer extends DyeableGeoItemRenderer<ZunariKabutoItem> {

    protected float partialTick;

    public ZunariKabutoItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (ZunariKabutoItem)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(ZunariKabutoItem animatable, ResourceLocation texture,
