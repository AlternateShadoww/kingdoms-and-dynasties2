...
public class Jingasa4ItemRenderer extends DyeableGeoItemRenderer<Jingasa4Item> {

    protected float partialTick;

    public Jingasa4ItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (Jingasa4Item)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(Jingasa4Item animatable, ResourceLocation texture,
