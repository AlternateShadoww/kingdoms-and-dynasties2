...
public class GihakamaItemRenderer extends DyeableGeoItemRenderer<GihakamaItem> {

    protected float partialTick;

    public GihakamaItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (GihakamaItem)stack.getItem();
    ...
    protected @NotNull Color getColorForBone(GeoBone geoBone) {
        ...
        if (itemStack.getItem() instanceof GihakamaItem armorItem) {
        ...
        return Color.ofOpaque(GihakamaItem.STANDARD_COLOR);
    }
    ...
    @Override
    public RenderType getRenderType(GihakamaItem animatable, ResourceLocation texture,
