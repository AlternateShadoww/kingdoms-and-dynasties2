...
public class KariginuItemRenderer extends DyeableGeoItemRenderer<KariginuItem> {

    protected float partialTick;

    public KariginuItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (KariginuItem)stack.getItem();
    ...
    protected @NotNull Color getColorForBone(GeoBone geoBone) {
        ...
        return Color.ofOpaque(KariginuItem.STANDARD_COLOR);
    }
    ...
    @Override
    public RenderType getRenderType(KariginuItem animatable, ResourceLocation texture,
