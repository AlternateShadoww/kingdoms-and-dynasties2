...
public class HaraateHakamaItemRenderer extends DyeableGeoItemRenderer<HaraateHakamaArmorItem> {

    protected float partialTick;

    public HaraateHakamaItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (HaraateHakamaArmorItem)stack.getItem();
    ...
    private void applyGuiTransformations(PoseStack poseStack, ArmorItem.Type armorType) {
        switch (armorType) {
            case HELMET:
                poseStack.translate(0.8F, -1.5F, 0.0F);
    ...
    protected @NotNull Color getColorForBone(GeoBone geoBone) {
        ...
        return Color.ofOpaque(HaraateHakamaArmorItem.STANDARD_COLOR);
    }
    ...
    @Override
    public RenderType getRenderType(HaraateHakamaArmorItem animatable, ResourceLocation texture,
