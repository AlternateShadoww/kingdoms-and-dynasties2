...
public class Jingasa2ItemRenderer extends DyeableGeoItemRenderer<Jingasa2Item> {

    protected float partialTick;

    public Jingasa2ItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (Jingasa2Item)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(Jingasa2Item animatable, ResourceLocation texture,
