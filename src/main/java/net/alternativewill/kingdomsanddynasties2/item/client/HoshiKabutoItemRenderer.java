...
public class HoshiKabutoItemRenderer extends DyeableGeoItemRenderer<HoshiKabutoItem> {

    protected float partialTick;

    public HoshiKabutoItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (HoshiKabutoItem)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(HoshiKabutoItem animatable, ResourceLocation texture,
