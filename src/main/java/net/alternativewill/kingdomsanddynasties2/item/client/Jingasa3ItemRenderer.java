...
public class Jingasa3ItemRenderer extends DyeableGeoItemRenderer<Jingasa3Item> {

    protected float partialTick;

    public Jingasa3ItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (Jingasa3Item)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(Jingasa3Item animatable, ResourceLocation texture,
