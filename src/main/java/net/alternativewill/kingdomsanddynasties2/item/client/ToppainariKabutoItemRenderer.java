...
public class ToppainariKabutoItemRenderer extends DyeableGeoItemRenderer<ToppainariKabutoItem> {

    protected float partialTick;

    public ToppainariKabutoItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (ToppainariKabutoItem)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(ToppainariKabutoItem animatable, ResourceLocation texture,
