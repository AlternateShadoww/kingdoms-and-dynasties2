...
public class TankoItemRenderer extends DyeableGeoItemRenderer<TankoArmorItem> {

    protected float partialTick;

    public TankoItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (TankoArmorItem)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(TankoArmorItem animatable, ResourceLocation texture,
