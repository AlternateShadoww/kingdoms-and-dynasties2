...
public class EboshiKabutoItemRenderer extends DyeableGeoItemRenderer<EboshiKabutoItem> {

    protected float partialTick;

    public EboshiKabutoItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (EboshiKabutoItem)stack.getItem();
    ...
    @Override
    public RenderType getRenderType(EboshiKabutoItem animatable, ResourceLocation texture,
