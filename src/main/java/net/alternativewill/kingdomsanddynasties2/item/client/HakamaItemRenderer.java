...
public class HakamaItemRenderer extends DyeableGeoItemRenderer<HakamaNewItem> {

    protected float partialTick;

    public HakamaItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (HakamaNewItem)stack.getItem();
    ...
    protected @NotNull Color getColorForBone(GeoBone geoBone) {
        ...
        return Color.ofOpaque(HakamaNewItem.STANDARD_COLOR);
    }
    ...
    @Override
    public RenderType getRenderType(HakamaNewItem animatable, ResourceLocation texture,
