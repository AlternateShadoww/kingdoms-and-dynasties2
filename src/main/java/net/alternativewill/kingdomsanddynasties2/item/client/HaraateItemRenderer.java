...
public class HaraateItemRenderer extends DyeableGeoItemRenderer<HaraateArmorItem> {

    protected float partialTick;

    public HaraateItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (HaraateArmorItem)stack.getItem();
    ...
    private void applyGuiTransformations(PoseStack poseStack, ArmorItem.Type armorType) {
        switch (armorType) {
            case HELMET:
                poseStack.translate(1.2F, -1.5F, 0.0F);
    ...
    protected @NotNull Color getColorForBone(GeoBone geoBone) {
        ...
        return Color.ofOpaque(HaraateArmorItem.STANDARD_COLOR);
    }
    ...
    @Override
    public RenderType getRenderType(HaraateArmorItem animatable, ResourceLocation texture,
