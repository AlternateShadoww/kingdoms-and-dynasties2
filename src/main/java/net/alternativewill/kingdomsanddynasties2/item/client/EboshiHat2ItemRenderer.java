...
public class EboshiHat2ItemRenderer extends DyeableGeoItemRenderer<EboshiHat2Item> {

    protected float partialTick;

    public EboshiHat2ItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (EboshiHat2Item)stack.getItem();
    ...
    private void applyGuiTransformations(PoseStack poseStack, ArmorItem.Type armorType) {
        switch (armorType) {
            case HELMET:
                poseStack.translate(0.65F, -1.75F, 0.0F);
    ...
    @Override
    public RenderType getRenderType(EboshiHat2Item animatable, ResourceLocation texture,
