...
public class GiNewItemRenderer extends DyeableGeoItemRenderer<GiNewItem> {

    protected float partialTick;

    public GiNewItemRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        this.animatable = (GiNewItem)stack.getItem();
    ...
    protected @NotNull Color getColorForBone(GeoBone geoBone) {
        ...
        return Color.ofOpaque(GiNewItem.STANDARD_COLOR);
    }
    ...
    @Override
    public RenderType getRenderType(GiNewItem animatable, ResourceLocation texture,
