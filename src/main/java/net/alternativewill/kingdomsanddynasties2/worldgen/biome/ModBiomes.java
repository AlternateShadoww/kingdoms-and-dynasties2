...
import net.alternativewill.kingdomsanddynasties2.worldgen.ModPlacedFeatures;
...
public class ModBiomes {
    public static final ResourceKey<Biome> TEST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(KingdomsAndDynasties2.MOD_ID, "test_biome"));
    ...
    public static Biome testBiome(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.MULLBERRY_PLACED_KEY);
